            ...
            <div id="wrapper">
                ...
                <div id="sidebar-wrapper">
                    ...
                    <ul class="sidebar-nav" id="sidebar">
                        <li><a href = "view_students.php">View Students<span class="sub_icon glyphicon glyphicon-user"></span></a></li>
                        <li><a href = "add_subject.php">Add Subject<span class="sub_icon glyphicon glyphicon-plus"></spa n></a></li>
                        <li><a href = "pin.php">Generate Pin<span class="sub_icon glyphicon glyphicon-lock"></span></a></li>
                        <li><a href = "view_results.php">View Results<span class = "sub_icon glyphicon glyphicon-folder-open"></span></a></li>
                        <li><a href = "manage_questions.php">Manage Questions<span class = "sub_icon glyphicon glyphicon-list-alt"></span></a></li>
                    </ul>
